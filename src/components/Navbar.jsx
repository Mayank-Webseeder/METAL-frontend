...
//                         <div className="inline-block animate-spin h-4 w-4 border-2 border-gray-300 border-t-indigo-600 rounded-full"></div>
...
//               <Bars3Icon className="h-6 w-6" />
//             </button>
//             <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 ml-2 lg:ml-64">
